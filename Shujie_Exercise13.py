# Q1 3 Write a line of code to create a file handle to open and append to a file called pelican.txt

pelican = open('spelican.txt', 'w')
...
# There's nothing in the file to read yet

# 4 Append the line into the file using write method
pelican_write = open('spelican.txt', 'a')
...
# the writelines method will add the list variable 'lines' into the file
